          ...
          <Card className="max-w-xl mx-auto bg-gray-800 border-2 border-gray-700 hover:border-buttercup transition-colors text-white text-center">
            <CardContent className="p-6 sm:p-8">
              ...
              <Button
                ...
                asChild
              >
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdpGScG5keRrPnXk3q-qDLXzQoC4Ij8i4bUT7ir-KTeFB4m4A/viewform?usp=header" target="_blank" rel="noopener noreferrer">
                  Become A Member!
                </a>
              </Button>
            </CardContent>
