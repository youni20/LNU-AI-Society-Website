    ...
    <div className="min-h-screen bg-soot-glue">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-6xl font-bold text-soot-glue mb-6">
              Shaping the Future with <span className="text-soot-glue">Artificial Intelligence</span>
            </h1>
      ...
      <section className="py-20 bg-crocus">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Ready to Join the AI Revolution?</h2>
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Whether you're a beginner or an expert, there's a place for you in our community. Join us and be part of
